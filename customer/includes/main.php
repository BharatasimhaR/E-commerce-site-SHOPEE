      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="../index.php">
            <img class="logo__img" src="../images/logo-small.png" alt="Avenue fashion logotype" width="120" height="5">
          </a>
        </div>
              ...
              <!-- <div class="dropdown dropdown--lookbook">
                <div class="clearfix">
                  <div class="dropdown__half">
                    <div class="dropdown__heading"><a href="edit_account.php">Account Settings</a></div>
